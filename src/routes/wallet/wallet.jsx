...
const Wallet = ({wallet}) =>{
    ...
    let content =  
        <div className="h-screen">
            <div className="w-[250px] h-[149px] bg-register-btn shadow-xl m-5 rounded-b-3xl ">
                <div className="bg-white w-full h-[120px] flex flex-col justify-evenly rounded-b-3xl">
                ...
                {/* Show amount toggle function */}
                {
                    showAmount? 
                        ...
                        <p className="text-3xl">&#8358; {wallet.amount}</p>
            ...
            <div className="h-[300px] mx-auto flex flex-col justify-center items-center shadow-2xl gap-12 px-12 py-6 max-w-[555px]">
