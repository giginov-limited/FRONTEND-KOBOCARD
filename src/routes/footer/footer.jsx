...
const Footer = () => {
    ...
    return (
        <div>
            ...
            <footer className="p-4 bg-black w-full text-white font-inter sm:p-6 ">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="/" className="flex items-center">
                            <span className="self-center text-3xl  whitespace-nowrap dark:text-white">KoboCard</span>
                        </a>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">KoboCard™</a>. All Rights Reserved.
                    </span>
